...
-- AlterTable
ALTER TABLE "payments" ALTER COLUMN "ideaId" DROP NOT NULL;
...
-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_ideaId_fkey" FOREIGN KEY ("ideaId") REFERENCES "ideas"("id") ON DELETE SET NULL ON UPDATE CASCADE;
